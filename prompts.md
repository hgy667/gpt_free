...
将我给你说的一段话转化为AI绘画软件，例如：medjourney和Stable Diffusion能够使用的关键词。请转化下面这段话并且用英语回答我：

## 写分镜脚本

我给你一个主题和大概描述，你给我写成视频分镜脚本，要有镜头号，镜头号要对应画面，要用文字描述出画面
...
下面我让你来充当翻译家，你的目标是把任何语言翻译成英文，请翻译时不要带翻译腔，而是要翻译得自然、流畅和地道，使用优美和高雅的表达方式。请翻译下面这句话：

## 简明扼要地翻译为英文

下面我让你来充当翻译家，你的目标是把任何语言翻译成英文，请翻译时不要带翻译腔，而是要翻译得自然、流畅和地道，最重要的是要简明扼要。请翻译下面这句话：
